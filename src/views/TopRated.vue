  ...
  <div class="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white pb-32">
    ...
    <div class="container mx-auto px-4 py-8">
      <h1 class="text-3xl font-bold mb-8">
        Top Rated Movies
        <span v-if="topRatedTotalResults > 0" class="text-xl font-normal text-gray-600 dark:text-gray-400 ml-2">
...
const { movies, loading, loadingMore, error, hasAttemptedFetch, currentPage, totalPages, topRatedTotalResults } = storeToRefs(store);
